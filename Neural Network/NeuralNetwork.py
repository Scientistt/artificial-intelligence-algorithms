...
a.startNeurons[0].goesTo[0][1] = 0.2
a.startNeurons[0].goesTo[1][1] = -0.3
a.startNeurons[1].goesTo[0][1] = 0.4
a.startNeurons[1].goesTo[1][1] = 0.1
a.startNeurons[2].goesTo[0][1] = -0.5
a.startNeurons[2].goesTo[1][1] = 0.2
a.internalNeurons[0][0].goesTo[0][1] = -0.3
a.internalNeurons[0][1].goesTo[0][1] = -0.2
a.internalNeurons[0][0].tendency = -0.4
a.internalNeurons[0][1].tendency = 0.2
a.finalNeurons[0].tendency = 0.1
